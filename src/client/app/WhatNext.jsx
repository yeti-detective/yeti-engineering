...
function WhatNext(){
    return(
        <div>
            ...
            <PaypalButton />
            <p>To witness my powers with a MongoDB deployment, check out my <strong><a style={style} href="https://url-redirect-maker.herokuapp.com/" target="blank">url redirect maker</a></strong>. That's based on an <a href="https://github.com/yeti-detective/yet-azwl-api" target="_blank" style={{color: "#3F5A95"}}>API I made</a> using the npm osmosis package (web scraper.) It validates the URL with npm's 'valid-url' package.</p>
