  ...
  <div className="just-following-up">
    ...
    <div className="just-following-up-container">
      ...
      <section className="jfu-pane jfu-right-pane">
        ...
        <p>
          ...
          as well as an email address by way of the{" "}
          <a href="https://auth0.com/" target="_blank">
            Auth0 API
          </a>
          . On first login, the user is prompted to enter their company
          information. They can then go on to track customers, invoices and due
          dates.
        </p>
        <p>
          The tech stack for Just Following Up on the web consists of a Node
          Express server connected by a JavaScript client to a MongoDB database
          hosted on{" "}
          <a href="https://mlab.com/" target="_blank">
            Mlab
          </a>
          , and a React-powered web client on the frontend.
        </p>
      </section>
    </div>
    <br />
    ...
    <section className="jfu-native grid-daddy">
      <div className="col col-1-3 native-words">
        <p>
          The Android version of Just Following Up hits the same backend server
          as the web app, so a user will be logging into the same account
          whether it's from a browser or their mobile. The front end was built
          in React Native, but the final APK was produced in Android Studio and
          uploaded to the Play store through the Google Play Console.
        </p>
      </div>
