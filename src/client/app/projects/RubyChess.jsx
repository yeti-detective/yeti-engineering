...
const RubyChess = () => (
  <section className="ruby-chess">
    <h2>
      <a href="https://github.com/yeti-detective/RubyChess" target="_blank">
        Ruby Chess
      </a>
    </h2>
    ...
    <div className="ruby-chess-words">
      <p>
        This is a pure-Ruby project <em>(still in development.)</em> The goal is
        to create a computer chess opponent that models a tree data structure
      ...
      <p>
        While creating this tree structure, it will use{" "}
        <a
        ...
        to find the shortest branch that ends in victory, and then pursue the
        course of action defined by that branch.
      </p>
      <p>
        I hope to gain some insight into AI in the pursuit of this project.
        Watch{" "}
        <a href="https://github.com/yeti-detective/RubyChess">this space</a> for
        updates.
      </p>
    </div>
    <hr />
