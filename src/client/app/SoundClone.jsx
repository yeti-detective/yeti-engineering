...
const SoundClone = props => (
    <div>
        ...
        <p>Check out my full-stack project, Rails backend, React frontend. It's a clone of <a href="https://www.soundcloud.com" target="_blank">SoundCloud</a></p>
        ...
        <a href="https://chris-b-soundclone.herokuapp.com" target="_blank"><img 
