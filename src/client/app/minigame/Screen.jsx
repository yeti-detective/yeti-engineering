...
class Screen extends React.Component {
    ...
    render(){
        ...
        <svg style={style} className="screen" ref="node">
            ...
            <rect x="40%" y="370" fill="#153162" height="30" width="16%" />
            <rect x="55%" y="340" fill="#153162" height="60" width="16%" />
            <rect x="70%" y="310" fill="#153162" height="90" width="16%" />
            <rect x="85%" y="280" fill="#153162" height="120" width="16%" />
            <rect x="90%" y="240" fill="#153162" height="40" width="3" />
